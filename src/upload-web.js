...
async function readProfile() {
 ...
 async function uploadFile(event) {
    ...
    const url = `${MY_POD}${file.name}`;
    try {
        // TODO: content type text/plain or text/turtle
        const fileResponse = await saveFileInContainer(MY_POD, file, { contentType: "text/turtle" ,  fetch: session.fetch});
        document.getElementById(
            "labelUploadStatus"
